...
def gestionar_cuentas():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            saldo_inicial = 0
        current_app.cuenta_bancaria_facade.crear_cuenta(nombre, saldo_inicial, usuario_id)
...
def datos_cuenta(cuenta_id):
    ...
    cuentas = current_app.cuenta_bancaria_facade.obtener_cuentas(cuenta.usuario_id)
